...
require_relative './lib/change_contact_name'
require_relative './lib/change_form_contact'
require_relative './database/queries/update_data'
...
loop do
  ...
  CLI::UI::Prompt.ask('Escolha qual ação quer realizar na agenda 👇') do |handler|
    ...
    handler.option('Alterar apenas o nome de uma pessoa') { change_contact_name_by_cpf }
